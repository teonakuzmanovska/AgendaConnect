...
//   }); // Constructor to initialize the meetings list.
...
//             ),
//             markers:
//                 locationProvider.extractMarkersFromMeetings(widget.meetings),
...
//           // "Exit Route" button, visible only when a route is active
...
//                   color: Colors.brown, // Button color aligning with the app
...
//                     style: TextStyle(
//                       color: Colors
//                           .white, // White text to contrast with brown button
//                       fontSize: 16.0,
//                       fontWeight: FontWeight
//                           .w500, // Make the text weight a bit stronger
//                     ),
//                   ),
//                 ),
//               ),
